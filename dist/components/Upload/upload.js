...
export var Upload = function (props) {
    ...
    return (React.createElement("div", { className: 'upload-component' },
        React.createElement("div", { className: 'upload-input', onClick: handleClick }, drag ?
            React.createElement(Dragger, { onFile: function (files) { upLoadFiles(files); } }, children) : children),
        React.createElement("input", { className: 'file-input', style: { display: 'none' }, onChange: handleChange, ref: inputRef, type: "file", multiple: multiple, accept: accept }),
